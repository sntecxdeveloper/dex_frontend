...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-screen bg-sidebar flex flex-col sidebar-transition ${
      ...
      >
        ...
        <div className={`flex items-center h-16 px-4 border-b border-white/10 ${sidebarCollapsed ? 'justify-center' : ''}`}>
          <div className="flex items-center gap-3 min-w-0">
            <div className="flex-shrink-0 h-9 w-9 rounded-lg bg-primary-600 flex items-center justify-center">
        ...
        <div className="hidden lg:flex items-center justify-center border-t border-white/10 py-3">
          <button
            onClick={() => dispatch(toggleSidebarCollapse())}
            className="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-white/10 btn-press transition-colors"
          >
            <motion.svg
